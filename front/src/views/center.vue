  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yisheng'"  label='预约价格' prop="yishengNewMoney">
                 <el-input v-model="ruleForm.yishengNewMoney"  placeholder='预约价格' disabled style="width: 100px"></el-input>
