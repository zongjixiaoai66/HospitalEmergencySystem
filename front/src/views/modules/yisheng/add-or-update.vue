    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约价格" prop="yishengNewMoney">
                       <el-input v-model="ruleForm.yishengNewMoney"
                                 placeholder="预约价格" clearable  :readonly="ro.yishengNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约价格" prop="yishengNewMoney">
                           <el-input v-model="ruleForm.yishengNewMoney"
