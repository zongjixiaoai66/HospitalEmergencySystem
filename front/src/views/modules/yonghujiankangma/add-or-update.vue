    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghujiankangmaPhoto" label="健康码" prop="yonghujiankangmaPhoto">
                        <file-upload
                            tip="点击上传健康码"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yonghujiankangmaPhoto?ruleForm.yonghujiankangmaPhoto:''"
                            @change="yonghujiankangmaPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghujiankangmaPhoto" label="健康码" prop="yonghujiankangmaPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.yonghujiankangmaPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yonghujiankangmaPhoto: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yonghujiankangmaPhoto: '',
                },
                yonghuOptions : [],
                rules: {
                   yonghuId: [
        ...
        methods: {
            ...
            //图片
            yonghujiankangmaPhotoUploadChange(fileUrls){
                this.ruleForm.yonghujiankangmaPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
